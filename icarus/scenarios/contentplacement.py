...
__all__ = ['uniform_content_placement', 'content_placement_from_data', 'weighted_content_placement', 'zipf_content_placement']
...
def zipf_content_placement(topology, contents, alpha, seed=None):
    """Places content objects to source nodes randomly according to the weight
   ...
   contents : iterable
    ...
    zipf = TruncatedZipfDist(alpha, n_sources)._pdf
    source_weights = {}
